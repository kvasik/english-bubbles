...
public class ssCarThird extends Activity implements View.OnClickListener {
    String word = "";
    EditText edit;
    short sq = 0;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ssthirdlayout);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.back:
                Intent intent4 = new Intent(this, ssCar.class);
        ...
        if(sq == 3){
            sq = 0;
            Intent intent = new Intent(this, ssCarFourth.class);
